...
namespace Miniblog.Core.Serialization
{
    /// <summary>
    ...
    public class ReadOnlyJsonContractResolver : DefaultContractResolver
    {
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            {
                jsonProperty.ShouldSerialize = t => (propertyInfo.SetMethod != null && !propertyInfo.SetMethod.IsPrivate) || (propertyInfo.GetMethod != null && propertyInfo.GetMethod.IsStatic);
            }
