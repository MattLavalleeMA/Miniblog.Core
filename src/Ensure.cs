...
namespace Miniblog.Core
{
    ...
    /// Derived from Ben Foster's SaaSKit library:
    /// https://github.com/saaskit/saaskit/blob/master/src/SaasKit.Multitenancy/Ensure.cs
    /// </summary>
    [DebuggerStepThrough]
    public static class Ensure
    {
        ...
        /// <remarks><see cref="TException"/> must have a constructor that takes a single string</remarks>
        public static void IsNot<TException>(bool condition, string message = "") where TException : Exception
        {
        ...
        {
            IsNot<Exception>(condition, message);
        }
